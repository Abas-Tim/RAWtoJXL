...
cmake -S (Join-Path $root "native") -B $build -A x64 -DBUILD_TESTING=OFF -DBUILD_BENCHMARKING=OFF -DALLOW_DOWNLOADING_PUGIXML=ON -DWITH_JPEG=OFF -DUSE_BUNDLED_ZLIB=ON -DCMAKE_BUILD_TYPE=Release
