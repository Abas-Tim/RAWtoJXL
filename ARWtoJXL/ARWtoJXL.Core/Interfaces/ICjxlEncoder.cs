...
namespace ARWtoJXL.Core.Interfaces
{
    ...
    public interface ICjxlEncoder
    {
        ...
        /// <param name="originalSourcePath">Path to the original source file (for metadata embedding).</param>
        ...
        /// <param name="skipMetadata">When true, skips metadata embedding for faster conversion.</param>
